...
import { CaptchaDappTerraClient } from './contract/clients/CaptchaDappTerraClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new CaptchaDappTerraClient(lcd, connectedWallet, contractAddress('captcha-dapp-terra', connectedWallet));
  }, [lcd, connectedWallet]);
